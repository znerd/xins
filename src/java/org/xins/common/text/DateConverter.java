/*
 * $Id: DateConverter.java,v 1.43 2007/09/18 08:45:07 agoubard Exp $
 *
 ...
 * stamp. There are two forms of output, a more verbose <em>date string</em>,
 * and a <em>format</em>.
 *
 * <h2>Date string</h2>
 * <p>The date string produced by the {@link #toDateString(long)} method is
 * more verbose, longer. For example, the date 26 July 2003, time 17:03, 59
 * seconds and 653 milliseconds converts to the string
 * <code>"2003.07.26 17:03:59.653"</code>.
 *
 * <h2>Format</h2>
 * <p>The format produced by the {@link #format(long)} method is shorter. The
 * actual output depends on whether the century should be output.
 *
 * <p>For example, the date 26 July 2003, time 17:03, 59 seconds and 653
 * milliseconds will convert to the string <code>"20030726-170359653"</code>
 * if the output includes a century, or to <code>"030726-170359653"</code> if
 * the output excludes the century.
 *
 * <p>See the
 * <a href="http://en.wikipedia.org/wiki/Unix_Epoch">Wikipedia article about the UNIX Epoch</a>
 * for more information.
 *
 * @version $Revision: 1.43 $ $Date: 2007/09/18 08:45:07 $
...
public class DateConverter {
   ...
   /**
    * Class initializer. Initializes the {@link #VALUES} array.
    */
   static {
    ...
    * The default time zone is used, see {@link TimeZone#getDefault()}
    *
    * @param time
